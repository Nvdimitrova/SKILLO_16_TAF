...
public class LoginPageLayout extends BaseTest {
    ...
    public void verifyLoginPagePlaceHolders() {
        ...
        String actualUserNameInputFieldPlaceholder = loginPage.verifyLoginUsernameInputFieldPlaceholder();
        ...
        String actualPasswordInputFieldPlaceholder = loginPage.verifyLoginPasswordInputFieldPlaceholder();
